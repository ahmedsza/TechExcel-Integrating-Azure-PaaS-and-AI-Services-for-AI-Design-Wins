...
public class DatabaseService : IDatabaseService
{
    ...
    public async Task<IEnumerable<Booking>> GetBookingsByHotelAndMinimumDate([Description("The ID of the hotel")] int hotelId, [Description("The Stay Begin Date")] DateTime dt)
    {
    ...
    [KernelFunction]
    [Description("retrieves bookings that do not have associated hotel rooms")]
    ...
    [KernelFunction]
    [Description("retrieve bookings that have multiple associated hotel rooms")]
